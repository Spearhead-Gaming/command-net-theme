# Reference fidelity update — v1.2.2
...
After the reviewed implementation is published as the stable **v1.2.2 Git tag**, run in the Forumify application directory:
...
After staging passes, merge the reviewed changes and create an annotated `v1.2.2` tag at that commit. Publish the release and refresh the Composer package index. Do not add a composer.json version field or retag v1.0.0 or v1.1.0.
